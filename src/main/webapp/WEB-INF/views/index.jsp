...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/RichFilemanager/src/css/libs-main.css" />
    <link rel="stylesheet" type="text/css" href="/static/RichFilemanager/src/css/filemanager.min.css" />
    ...
    <style type="text/css">
        .fm-container .fm-loading-wrap {
            ...
            left: 0;
            display: block;
            background: white url(/static/RichFilemanager/images/spinner.gif) no-repeat center center;
            z-index: 999;
        }
    </style>
...
<div class="fm-container">
    ...
    <div class="fm-wrapper">
        ...
        <script type="text/javascript" src="/static/RichFilemanager/src/js/libs-main.js"></script>
        <script type="text/javascript" src="/static/RichFilemanager/src/js/filemanager.min.js"></script>
        <script type="text/javascript" src="/static/RichFilemanager/config/filemanager.init.js"></script>
